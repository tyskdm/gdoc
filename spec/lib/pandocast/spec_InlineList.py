r"""! Software detailed design of 'InlineList' class written in pytest.

[@import IS[InlineList] from=PandocAst.md as=THIS]
...
import pytest
import inspect
from gdoc.lib.pandocast.pandocast import Element, Block, InlineList
...
def spec___init___r1_1():
    assert inspect.isclass(InlineList) == True
...
def spec___init___r1_2(element, type):
    ...
    target = InlineList(element, type)

    assert isinstance(target, InlineList)
