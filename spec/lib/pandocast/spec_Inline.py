...
@pytest.mark.parametrize("element, type, TYPES, expect", list(data___init___r1_3.values()), ids=list(data___init___r1_3.keys()))
## [\@spec __init___r1_3] | def __init__(self, pan_elem, elem_type, parent=None):
def spec___init___r1_3(element, type, TYPES, expect):

    target = Inline(element, type, TYPES)
