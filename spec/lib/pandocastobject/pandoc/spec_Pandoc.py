...
_data__run_1 = {
    ...
    "Case: One commandline": (
        ...
        {  # expected
            ...
            "wait": {"call_count": 1, "args": [[(), {}]]},
        },
    ),
    "Case: Two commandlines": (
        ["cmd 1", "cmd 2"],  # commandlines,
        [  # popen: [(returncode, b'stdout', b'stderr')],
    ...
    "Case: Three commandlines": (
        ["cmd 1", "cmd 2", "cmd 3"],  # commandlines,
        [  # popen: [(returncode, b'stdout', b'stderr')],
            (0, [b"STDOUT1"], [b"STDERR1"]),
            (0, [b"STDOUT2"], [b"STDERR2"]),
...
def spec__run_1(mocker, commandlines, popen, expected):
    ...
    mock_popen = mocker.patch(
        "gdoc.lib.pandocastobject.pandoc.pandoc.subprocess.Popen", side_effect=dummy_Popen
    )
...
_data_get_version_1 = {
    ...
    "Normal Case: Output in different format(1)": (
        ...
        {
            "output": {"pandoc": [2, 14, 2], "pandoc-types": [1, 22]},
            "_version_str": "pandoc 2.14.2, << FLLOWING SOME STRING\n"
    ...
    "Normal Case: Output in different format(2)": (
        ...
        {
            "output": {"pandoc": [2, 14, 2], "pandoc-types": [1, 22]},
            "_version_str": "pandoc-types 1.22\n" + "pandoc 2.14.2\n",
            "_run": {"call_count": 1, "args": [(["pandoc --version"],), {}]},
        },
    ),
    "Normal Case: Version strings are not only decimal char": (
        ...
        # expected
        {
            "output": {"pandoc": [2, "14b", 2], "pandoc-types": [1, "22a"]},
            "_version_str": "pandoc 2.14b.2\n" + "pandoc-types 1.22a\n",
            "_run": {"call_count": 1, "args": [(["pandoc --version"],), {}]},
        },
    ),
    "Normal Case: Skip if version string does not start with decimal char": (
        ...
        {
            "output": {"pandoc": [2, 14, 2], "pandoc-types": [1, 22]},
            "_version_str": "pandoc NOT.VERSION.STRING\n"
            + "pandoc 2.14.2\n"
            + "pandoc-types 1.22\n",
            "_run": {"call_count": 1, "args": [(["pandoc --version"],), {}]},
        },
...
def spec_get_version_2(mocker):
    ...
    """
    _VERSION_ = ({"pandoc": [0, 0, 0], "pandoc-types": [0, 0]},)
...
_data_get_json_1 = {
    ...
    "Case: .md with html=False": (["TEST.md", None, False], ["pandoc TEST.md -t json"]),
    "Case: .md with html=True": (
        ["TEST.md", None, True],
        ["pandoc TEST.md -t html", "pandoc -f html -t json"],
    ),
    "Case: .md with arguments, filetype='markdown' and html=True": (
        ["TEST.md", "markdown", True],
        ["pandoc TEST.md -f markdown -t html", "pandoc -f html -t json"],
    ),
...
@pytest.mark.parametrize(
    "args, expected", list(_data_get_json_1.values()), ids=list(_data_get_json_1.keys())
)
