...
> **Status:** 🟡 In Progress — Step 1 (UC-001 ✅, UC-002 ✅, UC-003…007 ⬜)
...
| ---- | ----------- | ------ |
| 1 | Sync + Lifecycle UCs (UC-001…007) | 🟡 2/7 (UC-001, UC-002 ✅) |
